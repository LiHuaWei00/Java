...
<html>
  ...
  <body>
  <div id="tebless">
  		<div class="milky">Cart query</div>
        ...
        <tbody>
        <tr>  
        	<td><input type="text" value="${u.gid}" class="input" /></td> 
            <td><input type="text" value="${u.gpic}" class="input"/></td>
            <td><input type="text" value="${u.gname}" class="input"/></td>
            <td><input type="text" value="${u.gcolor}" class="input"/></td>
            <td><input type="text" value="${u.gcm}" class="input"/></td> 
            <td><input type="text" value="${u.gmoney}" class="input"/></td>  
            <td><input type="text" value="${u.gcal}" class="input"/></td>   
    	...
    	<div id="wrapper1">
  		<form action="../servlet/Cartbutton">
